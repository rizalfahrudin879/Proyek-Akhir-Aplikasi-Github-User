package com.rizalfahrudin.submission.provider
...
import com.rizalfahrudin.submission.db.DatabaseContract.AUTHORITY
...
class UserProvider : ContentProvider() {
    ...
    companion object {
        ...
        init {
            // content://com.example.submission/user
            sUriMatcher.addURI(AUTHORITY, TABLE_NAME, USER)

            // content://com.example.submission/user/id
            sUriMatcher.addURI(
                AUTHORITY,
                "$TABLE_NAME/#",
                USER_ID
